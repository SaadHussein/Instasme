...
import privateClasses from "./TransferMoney.module.css";
...
import TransferMoneyTable from "../../../components/Accounting/TransferMoney/TransferMoneyTable/TransferMoneyTable";
...
const columnsTable = [
	...
	{ label: "From Account", visible: true },
	{ label: "To Account", visible: true },
	{ label: "Amount", visible: true },
	{ label: "Actions", visible: true },
];

const transferMoneyTableItems = [
	{
		date: "12-07-2024",
		fromAccount: "Mr. Hani Thabet",
		toAccount: "Saad Hussein",
		amount: "4000",
	},
];
						...
						>
							<div className="card card-flush p-5">
								...
								<TransferMoneyTable
									...
									transferMoneyTableItems={transferMoneyTableItems}
								/>
								<div
