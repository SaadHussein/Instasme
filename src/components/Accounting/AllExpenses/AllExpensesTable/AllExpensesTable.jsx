...
import classes from "./AllExpensesTable.module.css";
import {
	MdOutlineKeyboardArrowDown,
	MdOutlineKeyboardArrowUp,
} from "react-icons/md";
import AllExpensesTableRow from "../AllExpensesTableRow/AllExpensesTableRow";

const AllExpensesTable = ({ columnsVisible, allExpensesTable }) => {
	const [allExpenses, setAllExpenses] = useState([...allExpensesTable]);
	...
	const sortUponItem = () => {
		if (order === "no-order") {
			...
			setOrder("no-order");
			setSortItem("");
			setAllExpenses([...allExpensesTable]);
		}
	};
	return (
		<div
