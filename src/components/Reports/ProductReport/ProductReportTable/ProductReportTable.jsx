...
import ProductReportTableRow from "../ProductReportTableRow/ProductReportTableRow";
import {
	MdOutlineKeyboardArrowDown,
	MdOutlineKeyboardArrowUp,
} from "react-icons/md";
import classes from "./ProductReportTable.module.css";

const ProductReportTable = ({ productReportTableItems, columnsVisible }) => {
	const [productReport, setProductReport] = useState([
		...productReportTableItems,
	]);
	...
	const sortUponItem = () => {
		if (order === "no-order") {
			...
			setOrder("no-order");
			setSortItem("");
			setProductReport([...productReportTableItems]);
		}
	};
	return (
		<div
