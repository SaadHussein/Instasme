		...
		<tr>
			...
			{columnsVisible.map(
				(column) =>
					...
					column.visible && (
						<td className="text-end fw-bold text-gray-600">{company}</td>
					)
			)}
			{columnsVisible.map(
				(column) =>
					...
					column.visible && (
						<td className="text-end fw-bold text-gray-600">{department}</td>
					)
			)}
			{columnsVisible.map(
				(column) =>
					...
					column.visible && (
						<td className="text-end fw-bold text-gray-600">{designation}</td>
					)
			)}
			{columnsVisible.map(
				(column) =>
					...
					column.visible && (
						<td className="text-end fw-bold text-gray-600">{officeShift}</td>
					)
			)}
