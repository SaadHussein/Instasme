		...
		<tr>
			...
			{columnsVisible.map(
				(column) =>
					...
					column.visible && (
						<td className="text-end fw-bold text-gray-600">{timeIn}</td>
					)
			)}
			{columnsVisible.map(
				(column) =>
					...
					column.visible && (
						<td className="text-end fw-bold text-gray-600">{timeOut}</td>
					)
			)}
			{columnsVisible.map(
				(column) =>
					...
					column.visible && (
						<td className="text-end fw-bold text-gray-600">{workDuration}</td>
					)
			)}
...
export default AttendancesTableRow;
