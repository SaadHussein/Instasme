				...
				(column) =>
					...
					column.visible && (
						<td className="text-end text-primary fw-bold">
							$
							{count === 0 ? (
								<CountUp start={0} end={taxNumber} duration={3} />
							) : (
								taxNumber
							)}
						</td>
				...
				(column) =>
					...
					column.visible && (
						<td className="text-end text-primary fw-bold">
							$
							{count === 0 ? (
								<CountUp start={0} end={totalSaleDue} duration={3} />
							) : (
								totalSaleDue
							)}
						</td>
				...
				(column) =>
					...
					column.visible && (
						<td className="text-end text-primary fw-bold">
							$
							{count === 0 ? (
								<CountUp start={0} end={totalSaleReturnDue} duration={3} />
							) : (
								totalSaleReturnDue
							)}
						</td>
						...
						<td className="text-end">
							...
							>
								<div className="menu-item px-3">
									<div className="menu-link px-3">Customer Details</div>
								</div>
								<div className="menu-item px-3">
									<div className="menu-link px-3">Credit Card Info</div>
								</div>
								<div className="menu-item px-3">
									<div className="menu-link px-3">Edit Customer</div>
								</div>
								<div className="menu-item px-3">
									<div className="menu-link px-3">Delete Customer</div>
								</div>
							</div>
						</td>
					)
