...
import classes from "./SearchResultsMenu.module.css";

const SearchResultsMenu = ({ isSearchMenuOpen, setIsSearchMenuOpen }) => {
	return (
		<div
			data-kt-search-element="content"
			className={`menu menu-sub menu-sub-dropdown py-7 px-7 overflow-hidden w-300px w-md-350px ${
				isSearchMenuOpen ? `show ${classes.searchResultsMenu}` : ""
			}`}
		>
